...
export const ProjectSwitcher = ({
    ...
    <>
        ...
        >
            <i className="bi bi-folder-fill text-accent text-[11px]"></i>
        ...
        {isOpen && (
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-64 bg-border border border-menu-border rounded-lg shadow-2xl py-1 z-[200] animate-in fade-in zoom-in-95 duration-100">
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-2.5 px-3 py-1.5 text-left transition-colors
                                        ${isCurrent ? "bg-accent/10 cursor-default" : "hover:bg-accent group"}
                                    `}
                                >
                                    <i className={`bi bi-folder-fill text-[13px] ${isCurrent ? "text-accent" : "text-gray-500 group-hover:text-white"}`}></i>
                                    ...
                                    {isCurrent && <i className="bi bi-check2 text-accent text-[13px]"></i>}
                                </button>
                            );
                        })
                    )}
                ...
                <div className="h-[1px] bg-menu-border my-1 mx-0" />
                <MenuOption
